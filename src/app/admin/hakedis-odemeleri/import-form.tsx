...
import { importFreelancerPayoutsAction, type ImportResult } from "./import-actions";

const initialState: ImportResult = {};

export function ImportPayoutsForm() {
  const [state, formAction, pending] = useActionState(importFreelancerPayoutsAction, initialState);
  ...
  return (
    <div className="rounded-2xl border border-slate-200 bg-white p-6">
      ...
      <p className="mt-1 text-xs text-slate-500">
        Sütunlar: <span className="font-medium">Ad Soyad, IBAN, Tutar</span> — Tarih
        sütunu opsiyonel, boşsa bugünün tarihi kullanılır. Sütun sırası ya da büyük/küçük
        harf önemli değil.
      </p>
      ...
      {state.added !== undefined && (
        <div className="mt-4 space-y-2">
          <p className="text-sm text-emerald-600">{state.added} kayıt eklendi.</p>
